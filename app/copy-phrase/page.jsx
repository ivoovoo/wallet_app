            ...
            <div className={styles.page}>
                ...
                <div className={styles.grid}>
                    <div className={styles.grid_row}>
                        ...
                        <div className={styles.grid_item}>12. After</div>
                    </div>
                    <div className={styles.grid_row}>
                        <div className={styles.grid_item}>4. Alchemy</div>
                    ...
                    <div className={styles.grid_row}>
                        <div className={styles.grid_item}>11. Favor</div>
                        <div className={styles.grid_item}>12. Memo</div>
                    </div>
                </div>
                <div className={styles.download}>
                    <Image src='/copy.svg' alt='image' width={24} height={24} />
                    <p>Download all phrase</p>
                </div>
                <div className={styles.banner}>
                    Do not store your phrase in your email or phone note app.
                    Keep them safe and never share wih anybody
                </div>
